...
#import config
echo "perl ${SCRIPT}/genConfigIniForMerge_for_test_for_all.pl ${NEXTFLOWCONFIG} > config.ini" # modified for tests
perl ${SCRIPT}/genConfigIniForMerge_for_test_for_all.pl ${NEXTFLOWCONFIG} > config.ini        # modified for tests
