...
my $mappingGtf     = "$baseDir/mapping/mapping/$oPrefix.gtf";
my $mappingToMerge = "$baseDir/mapping/merge/$oPrefix\_merge.gff3";
my $gmapResult     = "$baseDir/denovo/$oPrefix\_denovo.cd.fasta.gmap.filtered";
my $denovoResult   = "$baseDir/denovo/$oPrefix\_final.gff3";
my $homologyResult = "$baseDir/homology/homology_filter/all_homology_filter.gff";
my $augustusResult = "$baseDir/abinitio/augustus/Augustus_abinitio.gtf";
my $snapResult     = "$baseDir/abinitio/snap/$oPrefix.final.gff";
